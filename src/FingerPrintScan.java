	...
	class CaptureCallbackImpl implements IFingerprintCaptureCallbackAPI
	{
		...
		{		
			...
			if(capturedBytes != null)
			{
				...
				File f = new File(Login.FingerDBpath+file1+".txt");
				File f1 = new File(Login.FingerDBpath+file1+"_2"+".txt");
				
				if(f.exists()) { 
//					FileHandling.writeUsingFileWriter(capturedBytes,Login.FingerDBpath+file1+"_2"+".txt");
					i++;
