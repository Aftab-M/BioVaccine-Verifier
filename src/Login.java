...
public class Login extends JFrame implements ActionListener,Runnable
{
	...
	try
		...
		cboUser.setBounds (15, 900, 105, 30);

		PinVal = new JPasswordField(20);
		PinVal.setHorizontalAlignment (JTextField.RIGHT);
		PinVal.setEchoChar('$');
		PinVal.setBounds (1105, 220, 190, 30);

		btnLogin = new JButton ("Sign In");
		btnLogin.setBounds (1170, 270, 120, 30);
		btnLogin.addActionListener (this);

		btnChange = new JButton ("Change");
		btnChange.setBounds (1170, 310, 120, 30);
		btnChange.addActionListener (this);

		JPanel panel = new JPanel ();
        JLabel label = new JLabel();
        panel.setBounds(2,2,1364,970);
        label.setIcon(new ImageIcon("Images/back.jpg"));// your image here
        panel.add(label);
